...
const checkUser = async(req, res, next) => {
    // request headers에 accesstoken이라는 이름으로 담긴 값(jwt)을 가져옵니다.
    ...
    try {
        ...
        console.log(error);
        functions.logger.error(`[AUTH ERROR] [${req.method.toUpperCase()}] ${req.origianalUrl}`, accesstoken);

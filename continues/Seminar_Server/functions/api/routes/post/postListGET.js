...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // 빌려온 connection을 사용해 우리가 db/post.js에서 미리 정의한 SQL 쿼리문을 날려줍니다.
    ...
    // try문 안에서 에러가 발생했을 시 catch문으로 error 객체가 넘어옵니다.
    ...
    // 여기서는 db.connection(req)를 통해 빌려온 connection을 connection pool에 되돌려줍니다.
